function [r_e,r_v,v_e,v_v] = EarthJupiterPosVel(t0,dt)
...
%   r_v - 3x1 col vector - Heliocentric position of Jupiter (in AU) at t0+dt
%   v_e - 3x1 col vector - Heliocentric-Inertial velocity of Earth 
%                          (in AU/day) at t0
%   v_v - 3x1 col vector - Heliocentric-Inertial velocity of Jupiter 
%                          (in AU/day) at t0+dt

%Earth and Venus orbital elements
ae = 1.000373836656026;
ee = 1.712127710968187e-2;
w_e = deg2rad(3.043573249748720e2);
I_e = deg2rad(2.777040607882003e-3);
O_e = deg2rad(1.596967974767415e2);
tpe = 2458853.731945450883;
mue = 2.9591309705483544e-4;
...
muj = 2.9619468438424372e-4;
    ...
    [t_e,x_e_p,y_e_p,vx_e_p,vy_e_p,E_e] = kepler_2body(ae,ee,mue,tpe,t0);
    [t_v,x_v_p,y_v_p,vx_v_p,vy_v_p,E_v] = kepler_2body(aj,ej,muj,tpj,t0);
    ...
    PCI_e=C3(w_e)*C1(I_e)*C3(O_e);
    PCI_v=C3(w_j)*C1(I_j)*C3(O_j);
